...
class VideoBlipQFormerConfig(PretrainedConfig):
    r"""
...
class VideoBlipConfig(PretrainedConfig):
    r"""
    ...
    def from_vision_qformer_text_configs(
        cls,
        vision_config: VideoBlipVisionConfig,
        qformer_config: VideoBlipQFormerConfig,
